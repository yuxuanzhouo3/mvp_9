...
const translations = {
  zh: {
    ...
    'pricing.free.storage': '1GB 存储空间',
    'pricing.free.files': '最多10个文件',
    'pricing.free.sharing': '基础分享功能',
    'pricing.free.support': '社区支持',
    'pricing.pro.title': '专业版',
    'pricing.pro.price': '¥29',
    'pricing.pro.period': '/月',
    'pricing.pro.storage': '100GB 存储空间',
    'pricing.pro.files': '无限文件数量',
    'pricing.pro.sharing': '高级分享功能',
    'pricing.pro.analytics': '详细分析报告',
    'pricing.pro.support': '优先技术支持',
    'pricing.enterprise.title': '企业版',
    'pricing.enterprise.price': '¥99',
    'pricing.enterprise.period': '/月',
    'pricing.enterprise.storage': '1TB 存储空间',
    'pricing.enterprise.files': '无限文件数量',
    'pricing.enterprise.sharing': '企业级分享功能',
    'pricing.enterprise.analytics': '高级分析工具',
  ...
  en: {
    ...
    'pricing.free.storage': '1GB Storage',
    'pricing.free.files': 'Up to 10 files',
    'pricing.free.sharing': 'Basic sharing',
    'pricing.free.support': 'Community support',
    'pricing.pro.title': 'Pro',
    'pricing.pro.price': '$29',
    'pricing.pro.period': '/month',
    'pricing.pro.storage': '100GB Storage',
    'pricing.pro.files': 'Unlimited files',
    'pricing.pro.sharing': 'Advanced sharing',
    'pricing.pro.analytics': 'Detailed analytics',
    'pricing.pro.support': 'Priority support',
    'pricing.enterprise.title': 'Enterprise',
    'pricing.enterprise.price': '$99',
    'pricing.enterprise.period': '/month',
    'pricing.enterprise.storage': '1TB Storage',
    'pricing.enterprise.files': 'Unlimited files',
    'pricing.enterprise.sharing': 'Enterprise sharing',
    'pricing.enterprise.analytics': 'Advanced analytics',
